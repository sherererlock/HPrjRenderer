...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class HairDepthFeature : ScriptableRendererFeature
    {
        class HairDepthRenderPass : ScriptableRenderPass
        {
            ...
            private Renderer hairMeshRenderer;
            private Material hairMat;
            private int shaodwCasterPass = -1;
            private int subMeshIndex = 0;

            public void Setup(ref RenderingData renderingData, SkinnedMeshRenderer renderer)
            {
                ...
                hairMeshRenderer = renderer;
                hairMat = renderer.sharedMaterial;
                shaodwCasterPass = hairMat.FindPass("ShadowCaster");
            }
